...
@_drawer("merge")
def _merge(p: QPainter, _c: QColor) -> None:
    # объединение: две линии слева сходятся в одну стрелку вправо
    _poly(p, (2.0, 3.5), (5.5, 3.5), (8.5, 8.0))
    _poly(p, (2.0, 12.5), (5.5, 12.5), (8.5, 8.0))
    _line(p, 8.5, 8.0, 13.6, 8.0)
    _poly(p, (11.3, 5.7), (13.8, 8.0), (11.3, 10.3))
