...
значений читать начиная с адреса). Все колонки — обычные ячейки, по таблице
можно перемещаться с клавиатуры. Кнопка ✕ удаляет строку.
...
бы на одну пробу, появляются в списке результатов. На время сканирования
поллинг в главном окне приостанавливается.
